...
class Sync {
  ...
  Future<void> syncFiles(LocalDirectory localDirectory, RemoteDirectory remoteDirectory) async {
  ...
  Future<void> syncDirectories(LocalDirectory localDirectory, RemoteDirectory remoteDirectory) async {
