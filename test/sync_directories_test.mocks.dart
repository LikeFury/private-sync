...
// in private_sync/test/sync_directories_test.dart.
...
import 'package:private_sync/models/config_model.dart' as _i2;
import 'package:private_sync/models/remote_directory_listing_model.dart' as _i4;
import 'package:private_sync/models/sync_directory_model.dart' as _i10;
import 'package:private_sync/models/sync_file_model.dart' as _i7;
import 'package:private_sync/remote_directory.dart' as _i8;
import 'package:private_sync/ssh.dart' as _i5;
...
class _FakeSSHClient_1 extends _i1.SmartFake implements _i3.SSHClient {
  _FakeSSHClient_1(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class _FakeSftpClient_2 extends _i1.SmartFake implements _i3.SftpClient {
  _FakeSftpClient_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class _FakeSftpFileAttrs_4 extends _i1.SmartFake implements _i3.SftpFileAttrs {
  _FakeSftpFileAttrs_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakeSsh_5 extends _i1.SmartFake implements _i5.Ssh {
  _FakeSsh_5(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockSsh extends _i1.Mock implements _i5.Ssh {
  @override
  _i2.ConfigModel get config => (super.noSuchMethod(
  ...
  @override
  set config(_i2.ConfigModel? _config) => super.noSuchMethod(
        Invocation.setter(
          #config,
          _config,
        ),
  ...
  @override
  _i3.SSHClient get client => (super.noSuchMethod(
        Invocation.getter(#client),
        returnValue: _FakeSSHClient_1(
          this,
          Invocation.getter(#client),
        ),
        returnValueForMissingStub: _FakeSSHClient_1(
          this,
          Invocation.getter(#client),
        ),
      ) as _i3.SSHClient);
  ...
  @override
  set client(_i3.SSHClient? _client) => super.noSuchMethod(
        Invocation.setter(
          #client,
          _client,
        ),
  ...
  @override
  _i3.SftpClient get sftpClient => (super.noSuchMethod(
        Invocation.getter(#sftpClient),
        returnValue: _FakeSftpClient_2(
          this,
          Invocation.getter(#sftpClient),
        ),
        returnValueForMissingStub: _FakeSftpClient_2(
          this,
          Invocation.getter(#sftpClient),
        ),
      ) as _i3.SftpClient);
  ...
  @override
  set sftpClient(_i3.SftpClient? _sftpClient) => super.noSuchMethod(
        Invocation.setter(
          #sftpClient,
          _sftpClient,
        ),
  ...
  @override
  _i6.Future<_i4.RemoteDirectoryListingModel> listDirectory(
    String? path, {
    int? depth = 0,
  }) =>
      (super.noSuchMethod(
      ...
      ) as _i6.Future<_i4.RemoteDirectoryListingModel>);
  ...
  @override
  _i6.Future<_i3.SftpFileAttrs> statFile(String? path) => (super.noSuchMethod(
        Invocation.method(
          #statFile,
          [path],
        ),
        returnValue: _i6.Future<_i3.SftpFileAttrs>.value(_FakeSftpFileAttrs_4(
          this,
          Invocation.method(
            #statFile,
            [path],
...
class MockRemoteDirectory extends _i1.Mock implements _i8.RemoteDirectory {
  @override
  _i5.Ssh get sshClient => (super.noSuchMethod(
        Invocation.getter(#sshClient),
        returnValue: _FakeSsh_5(
          this,
          Invocation.getter(#sshClient),
        ),
        returnValueForMissingStub: _FakeSsh_5(
          this,
          Invocation.getter(#sshClient),
        ),
      ) as _i5.Ssh);
  ...
  @override
  set sshClient(_i5.Ssh? _sshClient) => super.noSuchMethod(
        Invocation.setter(
          #sshClient,
          _sshClient,
        ),
  ...
  @override
  List<_i10.SyncDirectoryModel> get directories => (super.noSuchMethod(
        Invocation.getter(#directories),
        returnValue: <_i10.SyncDirectoryModel>[],
        returnValueForMissingStub: <_i10.SyncDirectoryModel>[],
...
///
/// See the documentation for Mockito's code generation for more information.
class MockLocalDirectory extends _i1.Mock implements _i11.LocalDirectory {
  @override
  String get path => (super.noSuchMethod(
        Invocation.getter(#path),
        returnValue: _i9.dummyValue<String>(
